...
'''
age = 21
has_ticket = True #boolean 자료형일 때 python만 또 지혼자서 대문자로 시작합니다.
...
논리 연산자 :
    ...
    2) of : A or B -> A 혹은 B 중에 하나가 참이면 실행문 실행
    3) not : if not A -> A가 false 일 때 실행문 실행
